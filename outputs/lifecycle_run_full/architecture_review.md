# Reference Architecture: Enterprise Copilot with RAG and MCP Tools

**Scenario:** An internal enterprise copilot using RAG, long-term memory, MCP tools, and external SaaS APIs.
