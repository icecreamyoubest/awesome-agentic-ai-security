...
- Architecture template: MCP Runtime Security Gateway. Triggers: mcp; tool_use; external_api; agent_runtime. ASI risks: ASI01; ASI02; ASI03; ASI04; ASI05; ASI07. Components: Agent Runtime; MCP Gateway / PEP; Tool Descriptor Validator; Policy Decision Point; Ephemeral Credential Broker; Sandboxed Tool Runtime; Audit / OTel / SIEM. Controls: tool descriptor validation; least privilege tool scopes; per-action authorizatio… [S194](data/architecture_templates.json#mcp_runtime_security_gateway)
...
- [S194](data/architecture_templates.json#mcp_runtime_security_gateway) — Architecture template: MCP Runtime Security Gateway
